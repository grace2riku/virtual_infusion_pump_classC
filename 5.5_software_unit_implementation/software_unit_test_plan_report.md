...
#### 7.3.13 残 5 ユニット骨格(Step 19 B の TDD Red で詳細化)
...
**合計ケース数目安(全 17 ユニット):** **≥ 145 件**(代表 5 + UNIT-003.1 + UNIT-003.2 + UNIT-001.5 + UNIT-001.2 + UNIT-002.1 + UNIT-002.2 + UNIT-001.3 = 211 件実測 + 骨格 5 = 35 件の目安)。最終的な件数は Step 19 B の TDD で増減する見込み。
...
| UNIT-001.3 | **23**(うち UT-001.3-01..23 展開後 23、内訳:正常系 1 + 統合 3 + 異常系 6 + 境界 1 + RCM 2 + 並行 1 + 契約 5 + ライフサイクル 4)| **23** | 0 | 0 | **100.00% / 100.00% / 100%(MC/DC 試験設計担保、stop ファストパス + 通常キュー + token 一意性 + dispatch 例外耐性、`# pragma: no cover` 4 件は race-window/防御コード分岐)** | 2026-04-30 | Step 19 B13 PR マージコミット(TBD)|
