...
#### 7.3.12 残 6 ユニット骨格(Step 19 B の TDD Red で詳細化)
...
**合計ケース数目安(全 17 ユニット):** **≥ 145 件**(代表 5 + UNIT-003.1 + UNIT-003.2 + UNIT-001.5 + UNIT-001.2 + UNIT-002.1 + UNIT-002.2 = 188 件実測 + 骨格 6 = 41 件の目安)。最終的な件数は Step 19 B の TDD で増減する見込み。
