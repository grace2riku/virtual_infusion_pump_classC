...
| 優先度 | Medium(監査整合性に影響)|
| 状態 | 提案済み(Issue #6、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/6> |
...
| 状態 | 提案済み(Issue #7、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/7> |
...
| 状態 | 提案済み(Issue #8、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/8> |
...
| 状態 | 提案済み(Issue #9、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/9> |
...
| 状態 | 提案済み(Issue #10、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/10> |
...
| 状態 | 提案済み(Issue #11、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/11> |
...
| 状態 | 提案済み(Issue #12、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/12> |
...
| 状態 | 提案済み(Issue #13、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/13> |
...
| 状態 | 提案済み(Issue #14、2026-04-21) |
| upstream Issue | <https://github.com/grace2riku/iec62304_template/issues/14> |
