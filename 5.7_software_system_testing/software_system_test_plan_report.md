...
| **合計**(Inc.1 範囲、§6.1〜§6.3 + §6.5 + §6.7 集計)| **23**(Step 19 G + H2 + H3)| **14**(H2 で 7 + H3 で ST-IF 5 + ST-SEC 2 = 14)| **0** | **9**(Inc.4 申し送り 8 + Inc.1 完了タグ後 1、Step 19 H2 で確定)| 2026-05-07 | (Step 19 H2 / H3 PR マージコミット)|
