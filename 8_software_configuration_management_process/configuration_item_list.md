...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.4 | ドラフト(セルフ承認、Step 16 運用改善反映: UPSTREAM_FEEDBACK.md 新規登録) |
...
| CI-DOC-UPSTREAM | iec62304_template への修正要望台帳 | `UPSTREAM_FEEDBACK.md` | 0.1 | 初版(UF-001〜UF-009 を登録、upstream フィードバック用運用補助文書) |
