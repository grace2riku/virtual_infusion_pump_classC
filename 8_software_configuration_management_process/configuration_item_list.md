...
| CI-DOC-UTPR | ユニットテスト計画書/報告書 | `5.5_software_unit_implementation/software_unit_test_plan_report.md` | 0.15 | ドラフト(セルフ承認、Step 19 B15:UNIT-004.2 実施結果を §9.2 / §11 に反映、Pass 15 tests / カバレッジ 100% / MC/DC 100%(RCM-016)。§7.3.14 を新規詳細化(骨格の「≥ 8 / 100%」を 15 ケース / 100% に展開、運用性 4 + 専門性 5 論点を推奨方針で解消、UT 申し送りなし)、UNIT-002.3 行のコミット欄を Step 19 B14 PR #22 マージ SHA `00093e1` で確定、MINOR 区分・CR 不要、残骨格を 4 → 3 ユニットに更新)|
...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.22 | ドラフト(セルフ承認、Step 19 B15 反映:CI-SRC-007 に UNIT-004.2 Resume Confirmation Gate v0.1 追記(整合性検証層 UNIT-004.* 全 2 ユニット完成 + Inc.1 RCM 6 件全完了)、CI-TD-001p 新規登録、CI-TD-001c 対象から UNIT-004.2 を除外、CI-DOC-UTPR v0.15 反映、CI-DOC-DEVSTEPS v0.24 反映、自己参照 v0.22) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.24 | 継続更新(ステップ毎に追記、Step 19 B15 反映:UNIT-004.2 Resume Confirmation Gate TDD 実装、カバレッジ 100% / MC/DC 100% 達成、SRS-028 + SRS-RCM-016 実装で **整合性検証層 UNIT-004.* 全 2 ユニット完成 + Inc.1 RCM 6 件全完了**、残 4 → 3 ユニット、UTPR §7.3.14 を新規詳細化)|
...
| (予定) CI-TD-001c | UNIT-005.x 試験 | `tests/unit/test_*.py` | Step 19 B16+ 以降で UNIT-005.1 Control API などを順次 TDD Red で追加 |
