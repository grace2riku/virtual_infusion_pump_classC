...
| CI-DOC-UTPR | ユニットテスト計画書/報告書 | `5.5_software_unit_implementation/software_unit_test_plan_report.md` | 0.13 | ドラフト(セルフ承認、Step 19 B13:UNIT-001.3 実施結果を §9.2 / §11 に反映、Pass 23 tests / カバレッジ 100% / MC/DC 100%。§7.3.12 を新規詳細化(骨格の「≥ 10 / 95%」を 23 ケース / 100% に展開、運用性 4 + 専門性 5 論点を推奨方針で解消、UT 申し送り 5 例目)、MINOR 区分・CR 不要、残骨格を 6 → 5 ユニットに更新)|
...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.20 | ドラフト(セルフ承認、Step 19 B13 反映:CI-SRC-001 に UNIT-001.3 Command Handler v0.1 追記(制御系コア全 5 ユニット完成)、CI-TD-001n 新規登録、CI-DOC-UTPR v0.13 反映、CI-DOC-DEVSTEPS v0.22 反映、自己参照 v0.20) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.22 | 継続更新(ステップ毎に追記、Step 19 B13 反映:UNIT-001.3 Command Handler TDD 実装、カバレッジ 100% / MC/DC 100% 達成、SRS-010/013/014/P03/P04 + State Machine RCM-019 連携実装で **制御系コア UNIT-001.* 全 5 ユニット完成**、残 6 → 5 ユニット、UTPR §7.3.12 を新規詳細化)|
...
| (予定) CI-TD-001c | UNIT-002.3 / 004.2 / 005.x 試験 | `tests/unit/test_*.py` | Step 19 B14+ 以降で UNIT-002.3 Event Injection Stub などを順次 TDD Red で追加 |
