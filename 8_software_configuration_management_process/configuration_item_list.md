...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.5 | ドラフト(セルフ承認、Step 17b 反映: UPSTREAM_FEEDBACK.md v0.3 受領済み状態と CI-DOC-UPSTREAM v0.3 昇格に連動) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.6 | 継続更新(ステップ毎に追記、Step 17b 反映: upstream 9 件受領確認・UPSTREAM_FEEDBACK v0.3・CIL v0.5 連動) |
