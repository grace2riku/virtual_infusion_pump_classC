...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.6 | ドラフト(セルフ承認、Step 15b 後段反映: CR-0002 マージ(PR #6、SHA a741cda)によるプロセス規程 11 文書昇格(CCB v0.2 / SCMP v0.3 / SRMP v0.2 / SPRP v0.2 / SMP v0.2 / CRR v0.5 / SRS・SAD 参照整合据置 / CLAUDE 更新)に連動、自己参照 v0.6) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.8 | 継続更新(ステップ毎に追記、Step 15b 後段反映: CR-0002 クローズ連動の CRR v0.5 + CIL v0.6 更新を記録) |
