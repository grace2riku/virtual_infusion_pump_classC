...
| CI-DOC-UTPR | ユニットテスト計画書/報告書 | `5.5_software_unit_implementation/software_unit_test_plan_report.md` | 0.10 | ドラフト(セルフ承認、Step 19 B10:UNIT-001.2 実施結果を §9.2 / §11 に反映、Pass 21 tests / カバレッジ 100% / MC/DC 100%。§7.3.9 を新規詳細化(骨格の `pytest-benchmark` 注記を ITPR §5.6 申し送りに変更 → 詳細テーブル UT-001.2-01〜19、運用性 4 + 専門性 5 論点を推奨方針で解消)、MINOR 区分・CR 不要、残骨格を 9 → 8 ユニットに更新)|
...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.17 | ドラフト(セルフ承認、Step 19 B10 反映:CI-SRC-001 に UNIT-001.2 Control Loop v0.1 追記、CI-TD-001k 新規登録、CI-DOC-UTPR v0.10 反映、CI-DOC-DEVSTEPS v0.19 反映、自己参照 v0.17) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.19 | 継続更新(ステップ毎に追記、Step 19 B10 反映:UNIT-001.2 Control Loop TDD 実装、カバレッジ 100% / MC/DC 100% 達成、RCM-004 SW 送出側完了で制御系コア(UNIT-001.1 + 001.2 + 001.4 + 001.5 + 002.4)が連結可能に、残 9 → 8 ユニット、UTPR §7.3.9 を新規詳細化)|
...
| (予定) CI-TD-001c | UNIT-001.3 / 002.1 / 002.2 / 002.3 / 004.2 / 005.x 試験 | `tests/unit/test_*.py` | Step 19 B11+ 以降で UNIT-001.3 Command Handler などを順次 TDD Red で追加 |
