...
Phase 3(M0 基盤整備期)終了時点。バージョンは 2026-04-18 時点。
...
| CI-DOC-SRS | ソフトウェア要求仕様書 | `5.2_software_requirements_analysis/software_requirements_specification.md` | — | 未着手(Step 11 予定) |
| CI-DOC-SAD | ソフトウェアアーキテクチャ設計書 | `5.3_software_architecture_design/software_architecture_design.md` | — | 未着手(Inc.1 予定) |
| CI-DOC-SDD | ソフトウェア詳細設計書 | `5.4_software_detailed_design/software_detailed_design.md` | — | 未着手(Inc.1 予定) |
...
| CI-DOC-RMF | リスクマネジメントファイル(ISO 14971) | `7_software_risk_management_process/risk_management_file.md` | 0.1 | ドラフト(セルフ承認、継続更新) |
...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.1 | ドラフト(セルフ承認) |
| CI-DOC-CCB | CCB 運用規程 | `8_software_configuration_management_process/ccb_operating_rules.md` | — | 未着手(Step 10c 予定) |
| CI-DOC-CRR | 変更要求台帳 | `8_software_configuration_management_process/change_request_register.md` | — | 未着手(Step 10d 予定) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.1 | 継続更新(ステップ毎に追記) |
...
|---------------|---------|------|------|-------|--------------|---------|
| BL-20260418-001 | (予定) `planning-baseline` | 2026-04-18 | 計画凍結(M0 基盤整備期完了) | k-abe(セルフ) | CI-DOC-{SDP, SMP, SRMP, SSC, RMF, SCMP, SPRP, CIL}、CI-CFG-{001〜008}、CI-DOC-{README, DEVSTEPS, CLAUDE} | — |
| (予定) BL-YYYYMMDD-NNN | `inc1-requirements-frozen` | — | Inc.1 要求凍結 | — | + CI-DOC-SRS | — |
| (予定) BL-YYYYMMDD-NNN | `inc1-design-frozen` | — | Inc.1 設計凍結 | — | + CI-DOC-{SAD, SDD} | — |
| (予定) BL-YYYYMMDD-NNN | `inc1-baseline` | — | Inc.1 完了(試験合格) | — | + CI-SRC-{001, 005}、CI-TD-* | — |
| (予定) BL-YYYYMMDD-NNN | `v1.0.0` | — | 初回リリース | — | 全 CI | — |

> `planning-baseline` タグは Step 10 完了後(全補助ドキュメント揃った時点)に付与する予定。
