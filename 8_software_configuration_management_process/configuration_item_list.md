...
| CI-DOC-UTPR | ユニットテスト計画書/報告書 | `5.5_software_unit_implementation/software_unit_test_plan_report.md` | 0.3 | ドラフト(セルフ承認、Step 19 B3:UNIT-001.4 実施結果を §9.2 / §11 に反映、Pass 34 tests / カバレッジ 100% / MC/DC 100%。§7.3.2 を SRS-O-001 / SDD §4.2 に整合化、MINOR 区分・CR 不要)|
...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.10 | ドラフト(セルフ承認、Step 19 B3 反映:CI-SRC-001 に UNIT-001.4 v0.1 を追記、CI-TD-001d 新規登録、CI-DOC-UTPR v0.3 反映、自己参照 v0.10) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.12 | 継続更新(ステップ毎に追記、Step 19 B3 反映:UNIT-001.4 Flow Command Validator TDD 実装、カバレッジ 100% / MC/DC 100% 達成、UTPR §7.3.2 を SRS/SDD に整合化)|
...
| (予定) CI-TD-001c | UNIT-001.2 / 001.3 / 001.5 / 002.* 〜 005.3 試験 | `tests/unit/test_*.py` | Step 19 B4+ 以降で UNIT-002.4 などを順次 TDD Red で追加 |
