...
| CI-DOC-UTPR | ユニットテスト計画書/報告書 | `5.5_software_unit_implementation/software_unit_test_plan_report.md` | 0.8 | ドラフト(セルフ承認、Step 19 B8:UNIT-003.2 実施結果を §9.2 / §11 に反映、Pass 32 tests / カバレッジ 100% / MC/DC 100%。§7.3.7 を新規詳細化(骨格 → 詳細テーブル UT-003.2-01〜15、運用性 1 + 専門性 4 論点を推奨方針で解消、SDD §4.13.F タイミング試験は ITPR §5.6 申し送り)、MINOR 区分・CR 不要、残骨格を 11 → 10 ユニットに更新)|
...
| CI-DOC-CIL | 構成アイテム一覧(本書) | `8_software_configuration_management_process/configuration_item_list.md` | 0.15 | ドラフト(セルフ承認、Step 19 B8 反映:CI-SRC-006 に UNIT-003.2 Checksum Verifier v0.1 追記(永続化パイプライン完成)、CI-TD-001i 新規登録、CI-DOC-UTPR v0.8 反映、自己参照 v0.15) |
...
| CI-DOC-DEVSTEPS | 開発ステップ記録(お手本) | `DEVELOPMENT_STEPS.md` | 0.17 | 継続更新(ステップ毎に追記、Step 19 B8 反映:UNIT-003.2 Checksum Verifier TDD 実装、カバレッジ 100% / MC/DC 100% 達成、UNIT-003.* 全完了で永続化パイプライン完成、残 11 → 10 ユニット、UTPR §7.3.7 を新規詳細化)|
...
| (予定) CI-TD-001c | UNIT-001.2 / 001.3 / 001.5 / 002.1 / 002.2 / 002.3 / 004.2 / 005.x 試験 | `tests/unit/test_*.py` | Step 19 B9+ 以降で UNIT-001.5 SW Watchdog などを順次 TDD Red で追加 |
